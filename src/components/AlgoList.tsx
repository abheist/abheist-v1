...
const AlgoList = ({ posts: articles }) => {
  ...
  const articlesSection = {
    heading: 'Algorithms',
    description:
      'Here, I try to put all the algorithms which I learn and done on some platform. Mostly done on HackerRank, LeetCode, AlgoExpert of CodeChef. If you have any questions. You can also email me. Thank you 🙏',
    latestArticle: {
